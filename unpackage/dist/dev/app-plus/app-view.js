...
Z([3,'border-bottom border-light-secondary py-1'])
Z([3,' py-1 font-md text-muted text-center class-active'])
Z([3,'分类一'])
...
var x=['./components/common/card.wxml','./components/common/divider.wxml','./components/common/price.wxml','./components/common/radio-group.wxml','./components/search-list/search-list.wxml','./components/search/color-tag.wxml','./components/uni-ui/uni-badge/uni-badge.wxml','./components/uni-ui/uni-drawer/uni-drawer.wxml','./components/uni-ui/uni-icon/uni-icon.wxml','./components/uni-ui/uni-list-item/uni-list-item.wxml','./pages/cart/cart.wxml','./pages/ceshi/ceshi.wxml','./pages/class/class.wxml','./pages/my/aaaaaaa/aaaaaaa.wxml','./pages/my/my.wxml','./pages/search-lish/search-lish.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var o4=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],aZ,lY,gg)
var x5=_oz(z,9,aZ,lY,gg)
_(o4,x5)
_(b3,o4)
_(t1,b3)
return t1
...
cW.wxXCkey=2
_2z(z,3,oX,e,s,gg,cW,'item','index','index')
_(r,oV)
return r
}
...
var h9=_mz(z,'image',['class',2,'mode',1,'src',2],[],e,s,gg)
_(c8,h9)
_(f7,c8)
var o0=_n('view')
...
_(lCB,aDB)
_(o0,lCB)
var tEB=_mz(z,'price',['bind:__l',10,'vueId',1,'vueSlots',2],[],e,s,gg)
...
var z=gz$gwx_6()
var oJB=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
...
var aRB=_mz(z,'view',['catchtouchmove',1,'class',1,'data-event-opts',2],[],e,s,gg)
var tSB=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2],[],e,s,gg)
_(aRB,tSB)
...
var z=gz$gwx_10()
var fYB=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1,'hoverClass',2],[],e,s,gg)
var cZB=_n('view')
...
var o4B=_mz(z,'image',['class',7,'src',1],[],e,s,gg)
_(c3B,o4B)
_(h1B,c3B)
}
else{h1B.wxVkey=2
...
var t7B=_mz(z,'uni-icon',['bind:__l',11,'class',1,'color',2,'size',3,'type',4,'vueId',5],[],e,s,gg)
_(a6B,t7B)
_(l5B,a6B)
}
l5B.wxXCkey=1
...
var hEC=_mz(z,'view',['class',24,'style',1],[],e,s,gg)
var oFC=_v()
_(hEC,oFC)
if(_oz(z,26,e,s,gg)){oFC.wxVkey=1
var lIC=_mz(z,'uni-badge',['bind:__l',27,'text',1,'type',2,'vueId',3],[],e,s,gg)
_(oFC,lIC)
}
var cGC=_v()
_(hEC,cGC)
if(_oz(z,31,e,s,gg)){cGC.wxVkey=1
var aJC=_mz(z,'switch',['bindchange',32,'checked',1,'data-event-opts',2,'disabled',3],[],e,s,gg)
_(cGC,aJC)
}
var oHC=_v()
_(hEC,oHC)
if(_oz(z,36,e,s,gg)){oHC.wxVkey=1
var tKC=_mz(z,'uni-icon',['bind:__l',37,'class',1,'color',2,'size',3,'type',4,'vueId',5],[],e,s,gg)
_(oHC,tKC)
}
oFC.wxXCkey=1
oFC.wxXCkey=3
...
var z=gz$gwx_12()
var xOC=_n('view')
var oPC=_mz(z,'button',['bindtap',0,'data-event-opts',1,'type',1],[],e,s,gg)
...
var oTC=_mz(z,'scroll-view',['scrollY',-1,'class',2,'style',1],[],e,s,gg)
var cUC=_n('view')
...
_(oTC,cUC)
_(hSC,oTC)
var aXC=_mz(z,'scroll-view',['scrollY',-1,'style',7],[],e,s,gg)
var tYC=_v()
_(aXC,tYC)
var eZC=function(o2C,b1C,x3C,gg){
var f5C=_n('view')
var c6C=_oz(z,11,o2C,b1C,gg)
_(f5C,c6C)
_(x3C,f5C)
return x3C
}
tYC.wxXCkey=2
_2z(z,10,eZC,e,s,gg,tYC,'i','__i0__','')
_(hSC,aXC)
_(r,hSC)
return r
}
...
var hKD=_n('text')
_rz(z,hKD,'class',9,xGD,oFD,gg)
var oLD=_oz(z,10,xGD,oFD,gg)
_(hKD,oLD)
_(cJD,hKD)
var cMD=_n('view')
var oND=_n('view')
_rz(z,oND,'class',11,xGD,oFD,gg)
_(cMD,oND)
var lOD=_n('view')
...
var tQD=_mz(z,'text',['bindtap',14,'class',1,'data-event-opts',2],[],e,s,gg)
...
var hYD=_mz(z,'search-list',['bind:__l',22,'index',1,'item',2,'vueId',3],[],oVD,xUD,gg)
_(fWD,hYD)
return fWD
}
bSD.wxXCkey=4
_2z(z,20,oTD,e,s,gg,bSD,'item','index','index')
var oZD=_mz(z,'uni-drawer',['bind:__l',26,'bind:close',1,'data-event-opts',2,'mode',3,'visible',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var c1D=_mz(z,'card',['bind:__l',33,'headBorderBottom',1,'headTitle',2,'headTitleWeight',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var o2D=_mz(z,'zcmadio-group',['bind:__l',39,'bind:updateSelected',1,'data-event-opts',2,'label',3,'selected',4,'vueId',5],[],e,s,gg)
_(c1D,o2D)
_(oZD,c1D)
var l3D=_n('view')
_rz(z,l3D,'class',45,e,s,gg)
var a4D=_mz(z,'view',['class',46,'hoverClass',1],[],e,s,gg)
var t5D=_oz(z,48,e,s,gg)
_(a4D,t5D)
_(l3D,a4D)
var e6D=_mz(z,'view',['class',49,'hoverClass',1],[],e,s,gg)
...
var z=gz$gwx_17()
var x9D=_n('view')
var o0D=_mz(z,'card',['bind:__l',0,'bodyCover',1,'headTitle',1,'vueId',2],[],e,s,gg)
_(x9D,o0D)
var fAE=_n('view')
...
var aHE=_mz(z,'color-tag',['bind:__l',9,'item',1,'vueId',2],[],cEE,oDE,gg)
_(oFE,aHE)
return oFE
}
cBE.wxXCkey=4
...
_(x9D,fAE)
var tIE=_mz(z,'card',['bind:__l',12,'bodyPadding',1,'headBorderBottom',2,'headTitle',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var eJE=_v()
_(tIE,eJE)
var bKE=function(xME,oLE,oNE,gg){
var cPE=_mz(z,'color-tag',['bind:__l',22,'color',1,'item',2,'vueId',3],[],xME,oLE,gg)
_(oNE,cPE)
return oNE
}
eJE.wxXCkey=4
...
_(x9D,tIE)
var hQE=_mz(z,'divider',['bind:__l',26,'vueId',1],[],e,s,gg)
_(x9D,hQE)
var oRE=_mz(z,'card',['bind:__l',28,'headTitle',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var cSE=_mz(z,'uni-list-item',['bind:__l',32,'showArrow',1,'title',2,'vueId',3],[],e,s,gg)
_(oRE,cSE)
var oTE=_mz(z,'uni-list-item',['bind:__l',36,'showArrow',1,'title',2,'vueId',3],[],e,s,gg)
_(oRE,oTE)
_(x9D,oRE)
_(r,x9D)
return r
